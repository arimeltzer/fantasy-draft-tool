...
export default function YahooCallback() {
  ...
  return (
    <div className={`fixed inset-x-0 top-0 z-[60] mx-auto mt-3 flex w-fit max-w-[92vw] items-center gap-2 rounded-xl border px-3 py-2 text-xs shadow-lg ${tone}`}>
      ...
      {state !== "working" && (
        <button onClick={() => setState("idle")} className="ml-1 rounded-lg p-0.5 opacity-60 hover:opacity-100">
